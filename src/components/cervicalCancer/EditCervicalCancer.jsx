...
const EditCervicalCancer = () => {
    const { id } = useParams();
    const [initialValues, setInitialValues] = useState(initialData);
    const navigate = useNavigate();
    const { fetchCervicalCancerById, cervicalCancerDetails, updateCervicalCancer, modifyCervicalCancer } = useCervicalCancer();

    useEffect(() => {
        fetchCervicalCancerById(id);
    }, [id]);
    ...
    const handleUpdate = (values) => {
        ...
        updateCervicalCancer(id, updatedData);
        console.log("modifyCervicalCancer", modifyCervicalCancer)
        console.log('Values updated:', updatedData);
    };


    useEffect(() => {
        console.log("cervicalCancerDetails=", cervicalCancerDetails);
        if (cervicalCancerDetails) {
            const address = cervicalCancerDetails?.address || {};
            setInitialValues({
                ...cervicalCancerDetails,
                address: {
                    house: cervicalCancerDetails?.address.house || '',
                    city: cervicalCancerDetails?.address.city || '',
                    district: cervicalCancerDetails?.address.district || '',
                    state: cervicalCancerDetails?.address.state || '',
                    pincode: cervicalCancerDetails?.address.pincode || '',
                },
            });
        }
    }, [cervicalCancerDetails]);
...
export default EditCervicalCancer