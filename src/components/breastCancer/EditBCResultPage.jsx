...
const EditBCResultPage = () => {
    const { fetchAllBreastCancerPatients, fetchFilterData, deletePatient, deletePatientData, breastCancerData,
    ...
    useEffect(() => {
        fetchAllBreastCancerPatients().finally(() => setLoading(false));
        fetchFilterData({})
        fetchCities();
    }, []);
    ...
    const handleSubmit = (values, { setSubmitting }) => {
        const transformedData = transformDataForAPI(values.breastCancerData);
        // Update cervical cancer data
        updateBreastCancerResult(transformedData)
            .then(() => {
        ...
        <>
            <div className="mx-auto mt-5 p-5 bg-white shadow-md">
                <div className="flex justify-between items-center mb-4">
                    <div className="flex items-center">
                        ...
                        <h1 className="text-2xl font-bold">Breast Cancer</h1>
                    </div>
                    {/* <div>
          ...
          <button type="submit" className="btn btn-primary">
            Update
                ...
                <Formik
                    initialValues={{
                        breastCancerData: breastCancerData?.length > 0 ? breastCancerData?.map((item) => ({
                            _id: item._id || null,
                    ...
                    {({ values, handleChange, isSubmitting }) => (
                        <Form>
                            <table className="table-auto w-full mt-5 border-collapse">
                                ...
                                <tbody>
                                    {values.breastCancerData?.map((row, index) => (
                                        <tr key={index} className="border-b">
                                            <td>
                                                <Field
                                                    type="text"
                                                    name={`breastCancerData[${index}].personalName`}
                                            ...
                                            <td>
                                                <Field
                                                    as="select"
                                                    name={`breastCancerData[${index}].maritalStatus`}
                                            ...
                                            <td>
                                                <Field
                                                    type="text"
                                                    name={`breastCancerData[${index}].centerCode`}
                                            ...
                                            <td>
                                                <Field
                                                    type="text"
                                                    name={`breastCancerData[${index}].age`}
                                                    value={row.age}
                                                    onChange={handleChange}
                                                    className="input input-sm w-full"
                                                />
                                            ...
                                            <td>
                                                <Field
                                                    as="select"
                                                    name={`breastCancerData[${index}].gender`}
                                                    value={row.gender}
                                                    onChange={handleChange}
                                                    className="select select-sm w-full"
                                                >
                                            ...
                                            <td>
                                                <Field
                                                    as="select"
                                                    name={`breastCancerData[${index}].category`}
                                                    value={row.category}
                                                    onChange={handleChange}
                                                    className="select select-sm w-full"
                                                >
                                            ...
                                            <td>
                                                <Field
                                                    as="select"
                                                    name={`breastCancerData[${index}].caste`}
                                                    value={row.caste}
                                                    onChange={handleChange}
                                                    className="select select-sm w-full"
                                                >
                                            ...
                                            <td>
                                                <Field
                                                    as="select"
                                                    option={getCities}
                                                    name={`breastCancerData[${index}].location`}
                                                    // value={row.location}
                                                    value={row.location}
                                                    // onChange={handleChange}
                                                    onChange={(option) => {
                                            ...
                                            <td>
                                                <Field
                                                    as="select"
                                                    name={`breastCancerData[${index}].bloodGroup`}
                                            ...
                                            <td>
                                                <Field
                                                    as="select"
                                                    name={`breastCancerData[${index}].resultStatus`}
                                            ...
                                            <td>
                                                <Field
                                                    as="select"
                                                    name={`breastCancerData[${index}].cardStatus`}
...
export default EditBCResultPage