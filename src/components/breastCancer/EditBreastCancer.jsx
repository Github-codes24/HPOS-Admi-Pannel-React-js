...
const EditBreastCancer = () => {
    const { id } = useParams();
    const [initialValues, setInitialValues] = useState(initialData);
    const navigate = useNavigate();
    const { fetchBreastCancerById, breastCancerDetails, updateBreastCancer, modifyBreastCancer } = useBreastCancer();

    useEffect(() => {
        fetchBreastCancerById(id);
    }, [id]);
    ...
    const handleUpdate = (values) => {
        ...
        updateBreastCancer(id, updatedData);
        console.log("modifyBreastCancer", modifyBreastCancer)
        console.log('Values updated:', updatedData);
    };


    useEffect(() => {
        console.log("breastCancerDetails=", breastCancerDetails);
        if (breastCancerDetails) {
            const address = breastCancerDetails?.address || {};
            setInitialValues({
                ...breastCancerDetails,
                address: {
                    house: breastCancerDetails?.address.house || '',
                    city: breastCancerDetails?.address.city || '',
                    district: breastCancerDetails?.address.district || '',
                    state: breastCancerDetails?.address.state || '',
                    pincode: breastCancerDetails?.address.pincode || '',
                },
            });
        }
    }, [breastCancerDetails]);
...
export default EditBreastCancer